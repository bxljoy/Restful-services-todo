package com.alex.rest.webservices.restfulwebservices.jwt;
...
public class JwtSecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, HandlerMappingIntrospector introspector)
		...
		return httpSecurity
				.authorizeHttpRequests(auth -> auth.antMatchers("/authenticate").permitAll()
						...
						.permitAll() // h2-console is a servlet and NOT
	...
	public UserDetailsService userDetailsService() {
		UserDetails user = User.withUsername("alex").password("{noop}1234").authorities("read").roles("USER")
				.build();
